...
const collections = [
  ['user_accounts', 'email', 'Accounts', 'Registered people', 'users'],
  ['user_profiles', 'id', 'Couples', 'Shared profiles', 'heart'],
  ['learning_roadmaps', 'id', 'Roadmaps', 'Learning plans', 'path'],
  ['learning_tasks', 'id', 'Tasks', 'Daily actions', 'check'],
  ['expense_entries', 'id', 'Expenses', 'Money entries', 'wallet'],
  ['saving_tasks', 'id', 'Savings', 'Goals in motion', 'target'],
];
